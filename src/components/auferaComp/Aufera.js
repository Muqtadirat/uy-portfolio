  ...
  return (
    <div className="Aufera w-full h-[17372px] bg-base-colorssurface font-largescreen-body text-white">
          ...
          <div className="overview flex gap-[32px] mb-[88px] text-left">
            ...
            <div className="w-[668px]">
              ...
              <p className="mt-[3rem]">
                ...
                centered design and this helped me focus on a 4-step cycle
                design process of user research, product definition, sketching &
            ...
            <div className="w-[668px]">
              <ul>
                ...
                <li className="list-disc mt-[2rem] ml-12">
                  understand the two user groups that would be using this
                  product (Renters & Hosts)
                </li>
                <li className="list-disc mt-[2rem] ml-12">
              ...
              <ul className="mt-[2rem]">
                ...
                research was done at various stages of design using the
      ...
      <div className="userPersona bg-greyscale-100">
        <div className="personaWrapper mx-[72px] my-[80px] text-greyscale-40">
          <h2 className="text-greyscale-10 text-[48px] flex mb-[40px] font-largescreen-largedisplay">User Personas</h2>
          <div className="userCard bg-greyscale-97 border rounded-[4px] border-greyscale-90">
            <div ></div>
          </div>
        </div>
      </div>
