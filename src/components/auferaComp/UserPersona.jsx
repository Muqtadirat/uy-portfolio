...
function UserPersona() {
  return (
    <div className="userPersona bg-greyscale-100">
      <div className="personaWrapper mx-[72px] py-[80px] text-greyscale-40">
        <h2 className="text-greyscale-10 text-[48px] flex mb-[40px] font-largescreen-largedisplay">
          User Personas
        </h2>

        <div className="userCard bg-greyscale-97 border rounded-[4px] border-greyscale-90 gap-[10px] mb-[40px]">
          <div className="azeezCard mx-[72px] my-[56px] flex gap-[70px]">
            ...
            <div className="userDetails flex flex-col gap-[56px] leading-[24px]">
              <div className="wrapper flex gap-[32px] text-[18px]">
                <div className="bio w-[367px] h-[232px] flex flex-col text-left">
                  <p className="pb-[16px] font-bold text-[24px] font-largescreen-caption text-greyscale-20">
                    Bio
                  </p>
                  <p>
                ...
                <div className="frustration w-[367px] h-[232px] flex flex-col text-left">
                  <p className="pb-[16px] font-bold text-[24px] font-largescreen-caption text-greyscale-20">
                    Frustrations
                  </p>
                  <p>
              ...
              {""}
              <div className="wrapper flex gap-[32px] text-[18px]">
                <div className="motivation w-[367px] h-[232px] flex flex-col text-left">
                  <p className="pb-[16px] font-bold text-[24px] font-largescreen-caption text-greyscale-20">
                    Motivations
                  </p>
                  <p>
                ...
                <div className="goal w-[367px] h-[232px] flex flex-col text-left">
                  <p className="pb-[16px] font-bold text-[24px] font-largescreen-caption text-greyscale-20">
                    Goals
                  </p>
                  <p>
        ...
        <div className="userCard bg-greyscale-97 border rounded-[4px] border-greyscale-90 gap-[10px] mb-[40px]">
          <div className="nnenkaCard mx-[72px] my-[56px] flex gap-[70px]">
            <div className="flex flex-col items-start gap-[24px] text-[18px]">
        ...
        <div className="userCard bg-greyscale-97 border rounded-[4px] border-greyscale-90 gap-[10px] mb-[40px]">
          <div className="helenCard mx-[72px] my-[56px] flex gap-[70px]">
            <div className="flex flex-col items-start gap-[24px] text-[18px]">
        ...
        <div className="userCard bg-greyscale-97 border rounded-[4px] border-greyscale-90 gap-[10px] gap-x-[40px]">
          <div className="yemiCard mx-[72px] my-[56px] flex gap-[70px]">
            <div className="flex flex-col items-start gap-[24px] text-[18px]">
